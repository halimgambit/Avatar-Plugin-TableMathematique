...
exports.default = function (state) {
	...
	return new Promise(function (resolve, reject) {
		...
		for (var rule in Config.modules.TableMathematique.rules) {
			var match = (0, _helpers.syntax)(state.sentence, Config.modules.TableMathematique.rules[rule]); 
			if (match) break;
		}
		...
		setTimeout(function(){ 
			if (state.debug) info('Action TableMathematique');
			
			state.action = {
				module: 'TableMathematique',
				command: rule,
				room: room,
